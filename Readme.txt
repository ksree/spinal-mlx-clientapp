...
# How to send request to model
https://github.com/SeldonIO/seldon-core/blob/master/docs/reference/external-prediction.md
...
# An example for Iris Classifier might be:
...
curl -X POST -H 'Content-Type: application/json' -d '{"data":{"int":"8"}}' http://localhost:5000/
...
curl -g http://localhost:5000/predict --data-urlencode 'json={
                                                                 "meta": {},
                                                                 "data": {
                                                                   "names": [
                                                                     "x1",
